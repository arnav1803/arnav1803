...
- 🧠 Strong interest in **NLP, ML systems, and backend logic**
- 🛠️ Building projects to understand **how AI works in practice**
- 📈 Improving problem-solving through **DSA & system thinking**
- 🎯 Goal: Become a **solid AI / ML Engineer**, not just theory-heavy
...
- Python for ML  
- Java for DSA & backend logic  
- Model deployment fundamentals  
- MERN stack (learning & fixing concepts)
...
- **TruthGuard** – NLP-based Reddit claim analysis (learning real-time pipelines)  
- **Voice Tutor** – Speech-based English practice app  
- **HRMS System** – Full-stack system with attendance & salary logic  
- **AI Experiments** – Small ML & NLP models for concept clarity  

> Projects are built to **learn systems**, not just show outputs.
...
- ✔️ Strengthen DSA & problem-solving  
- ✔️ Learn model deployment & MLOps basics  
